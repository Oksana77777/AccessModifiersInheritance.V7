...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SavingAccount savingsAccount = new SavingAccount("Savings", 100, 50);
        ...
        CheckingAccount checkingAccount = new CheckingAccount("Checking", 100);
        ...
        CreditAccount creditAccount = new CreditAccount("Credit", -100);
